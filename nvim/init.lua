...
map({ 'n', 'v' }, '<leader>j', 'G', defaults)
map({ 'n', 'v' }, '<leader>k', 'gg', defaults)

map('n', '<C-Left>', ':vertical resize +5<CR>', defaults)
map('n', '<C-Right>', ':vertical resize -5<CR>', defaults)
...
map('n', '<leader>w', ':write<CR>', defaults)
...
map('i', '<C-S-CR>', '<esc>Ox<BS>', defaults)
...
-- Deactivating netrw because i use NvimTree
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>h', group = 'Start of line' },
        { '<leader>j', group = 'End of file' },
        { '<leader>k', group = 'Start of file' },
        { '<leader>l', group = 'End of line' },
        { '<leader>a', group = 'Quit [a]ll files' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        --
        defaults = {
          file_ignore_patterns = { 'node_modules', '.git', '.next', 'package-lock.json' },
          mappings = {
            n = {
      ...
      local global_mappings = require 'custom'
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Open float on current error
          map('<leader>F', vim.diagnostic.open_float, 'Open [F]loat')
  ...
  {
    'L3MON4D3/LuaSnip',
    build = 'make install_jsregexp CC=gcc', -- Requerido para expresiones regulares avanzadas
    dependencies = {},
    config = function()
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- cursor location to LINE:COL        -- require 'custom.plugins.snippets',
